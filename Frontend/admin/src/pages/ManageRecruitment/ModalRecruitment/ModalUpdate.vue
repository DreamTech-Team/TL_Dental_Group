...
const candidateRequirements = ref(props.selectedRecruitment.requirements);
const rightForCandidate = ref(props.selectedRecruitment.right);
const contract = ref(props.selectedRecruitment.contact);
const treat = ref(props.selectedRecruitment.treat);
...
onMounted(() => {
  selectedPosition.value = props.selectedRecruitment.position;
});
</script>
<template>
