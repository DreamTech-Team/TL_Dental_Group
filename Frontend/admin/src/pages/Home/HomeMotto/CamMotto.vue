...
<template>
  <div :class="$style.cammt__overlay">
    <div :class="$style.cammt__modal">
      <div :class="$style.cammt__modal__heading">
        THAY ĐỔI ẢNH
        <font-awesome-icon
          :icon="faXmark"
          :class="$style['cammt__modal-ic']"
          @click="$emit('close')"
        />
      </div>
      <div :class="$style.cammt__modal__body">
        <div :class="$style.cammt__ctn">
          <img :src="urlFile ? urlFile : AltImage" alt="meeting" />
          <div :class="$style.cammt__image_overlay">
