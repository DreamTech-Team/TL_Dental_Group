...
public class HomePageController {
    ...
    public ResponseEntity<ResponseObject> getHomeHeader() {
        return ResponseEntity.status(HttpStatus.OK).body(
                new ResponseObject("ok", "Get Header Successfully",
                        contentPageRepository.findHomePageByTypeName("home::header")));
    }
    ...
    public ResponseEntity<ResponseObject> updateContentPage(@RequestBody ContentPage entity) {
        ...
        if (foundContentPage.isPresent()) {
            ...
            if (currentContentPage.getType().equals("home::header")) {
                ...
                return ResponseEntity.status(HttpStatus.OK).body(
                        new ResponseObject("ok", "Update Content Page Successfully",
                                contentPageRepository.save(currentContentPage)));
            }
        }
    ...
    ResponseEntity<ResponseObject> getSection1() {
        ...
        Optional<ContentPage> section1SubItem1 = contentPageRepository
                .findHomePageByTypeName("home::section1_subitem1");
        Optional<ContentPage> section1SubItem2 = contentPageRepository
                .findHomePageByTypeName("home::section1_subitem2");
        Optional<ContentPage> section1SubItem3 = contentPageRepository
                .findHomePageByTypeName("home::section1_subitem3");

        if (section1Heading.isPresent() && section1SubItem1.isPresent() && section1SubItem2.isPresent()
                && section1SubItem3.isPresent()) {
            HomeSection1 homeSection1 = new HomeSection1(section1Heading.get(), section1SubItem1.get(),
                    section1SubItem2.get(), section1SubItem3.get());
    ...
    public ResponseEntity<ResponseObject> addSection1(@RequestParam("image") MultipartFile image,
            @RequestParam("data") String data, @RequestParam(name = "icon1", required = false) MultipartFile icon1,
            @RequestParam(name = "icon2", required = false) MultipartFile icon2,
            @RequestParam(name = "icon3", required = false) MultipartFile icon3)
        ...
        return ResponseEntity.status(HttpStatus.OK).body(
                new ResponseObject("ok", "Add Header Successfully",
                        contentPageRepository.saveAll(Arrays.asList(entity.getHeading(), entity.getSubItem1(),
                                entity.getSubItem2(), entity.getSubItem3()))));
    }

    @PreAuthorize(value = "hasRole('ROLE_ADMIN') || hasRole('ROLE_STAFF')")
    @PatchMapping(value = "/section1")
    public ResponseEntity<ResponseObject> updateSection1(
            @RequestParam(name = "image", required = false) MultipartFile image, @RequestParam("data") String data,
            @RequestParam(name = "icon1", required = false) MultipartFile icon1,
            @RequestParam(name = "icon2", required = false) MultipartFile icon2,
            @RequestParam(name = "icon3", required = false) MultipartFile icon3)
            throws JsonMappingException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        if (foundSection1Heading.isPresent() && foundSection1SubItem1.isPresent() && foundSection1SubItem2.isPresent()
                && foundSection1SubItem3.isPresent()) {
            ...
            if (section1Heading.getType().equals("home::section1_heading")
                ...
                return ResponseEntity.status(HttpStatus.OK).body(
                        new ResponseObject("ok", "Update Content Page Successfully", contentPageRepository.saveAll(
                                Arrays.asList(section1Heading, section1SubItem1, section1SubItem2, section1SubItem3))));
            }
        }
    ...
    public ResponseEntity<ResponseObject> addSection2(@RequestParam("data") String data,
    ...
    public ResponseEntity<ResponseObject> updateSection2(@RequestParam("data") String data,
            ...
            if (section2.getType().equals("home::section2")) {
                ...
                return ResponseEntity.status(HttpStatus.OK).body(
                        new ResponseObject("ok", "Update section 2 successfully",
                                contentPageRepository.save(section2)));
            }
        }
    ...
    public ResponseEntity<ResponseObject> addSection3(@RequestParam("data") String data,
            @RequestParam("image") MultipartFile image) throws JsonMappingException, JsonProcessingException {
        Optional<ContentPage> section3 = contentPageRepository.findHomePageByTypeName("home::section3");
    ...
    public ResponseEntity<ResponseObject> updateSection3(@RequestParam("data") String data,
            @RequestParam(name = "image", required = false) MultipartFile image)
            throws JsonMappingException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        ContentPage entity = objectMapper.readValue(data, ContentPage.class);
        ...
        if (foundSection3.isPresent()) {
            ...
            if (section3.getType().equals("home::section3")) {
                ...
                return ResponseEntity.status(HttpStatus.OK).body(
                        new ResponseObject("ok", "Update section 3 successfully",
                                contentPageRepository.save(section3)));
            }
        }
    ...
    ResponseEntity<ResponseObject> addReviews(@RequestParam("data") String data, @RequestParam("image") MultipartFile image) throws JsonMappingException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    public ResponseEntity<ResponseObject> updateReviews(@RequestParam("data") String data,
            @RequestParam(name = "image", required = false) MultipartFile image)
            throws JsonMappingException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        Review entity = objectMapper.readValue(data, Review.class);
